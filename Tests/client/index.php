...
const REDIRECT_URI           = 'http://flow.localhost/client/';
const AUTHORIZATION_ENDPOINT = 'http://flow.localhost/authorize';
const TOKEN_ENDPOINT         = 'http://flow.localhost/token';
...
else
{
    ...
    $response = $client->fetch('http://flow.localhost/resource');
